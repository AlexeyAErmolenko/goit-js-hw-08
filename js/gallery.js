...
//   .insertAdjacentHTML(
//     "afterbegin",
//     `<ul class="gallery">` + htmlCode + ` </ul>`
//   );

areaGallery.addEventListener("click", onImageClick);
...
function onImageClick(event) {
  ...
  if (event.target.dataset.source) {
    basicLightbox
      .create(
        `<img src="${event.target.dataset.source}" width="1112" height="640" background = "rgba(46, 47, 66, 0.8)">`
      )
      .show();
  }
}
